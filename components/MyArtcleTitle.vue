<template>
  <div :class="finalColorClass">
    <div class="text-center text-6xl font-bold dark:text-zinc-400">
      {{ title }}
    </div>
    <div
      class="flex items-center justify-center space-x-2 dark:text-zinc-400 my-10"
    >
      <svg
      ...
      <span v-if="wordCount" class="text-center text-sm"
        >≈{{ wordCount }}字</span
      >
    </div>
  </div>
