<template>
  <div class="px-4 py-8 flex items-center justify-center flex-col">
    ...
    <UButton class="mt-4" color="white" size="xs" @click="startCounter"> Start Counter </UButton>
    <p class="text-xs mt-2 text-gray-500">or start the counter when this component is in the viewport</p>
  </div>
</template>
