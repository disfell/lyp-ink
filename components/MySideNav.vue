<template>
  <div>
    <Transition name="slide">
      <div v-if="showNav" class="my-sidenav fixed right-3 bottom-24">
        <div>
          <div
            class="p-1 bg-slate-50 dark:bg-zinc-700 dark:text-zinc-400 grid place-content-center rounded-md cursor-pointer shadow-md"
          >
